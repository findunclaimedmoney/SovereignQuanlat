...
- Stripe: claimable sandbox (acct_1U75lxDAhIzDQmCo, country AU → managed payments/tax "full" mode). Catalog via setup_stripe.py (lookup keys professional_annual $49900, institutional_annual $199900, tax_code txcd_10103001). fulfil_order() is idempotent: marks paid, generates HMAC key, emails buyer.
